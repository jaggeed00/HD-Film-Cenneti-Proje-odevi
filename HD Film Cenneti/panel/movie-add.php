                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Film Ekle</h3>
                                <p class="text-subtitle text-muted">Web Sitenize film eklemek için aşağıdakı forumu doldurabilirsiniz.</p>
                            </div>
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php">Anasayfa</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Film Ekle
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" method="POST" id="movieadd" novalidate="" enctype='multipart/form-data'>
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="movie_ismi" id="movie_ismi">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="movie_yapimyil" id="movie_yapimyil">
                                                                <div class="form-control-icon">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="movie_sure" id="movie_sure">
                                                                <div class="form-control-icon">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="movie_imdb" id="movie_imdb">
                                                                <div class="form-control-icon">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="movie_imdblink" id="movie_imdblink">
                                                                <div class="form-control-icon">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea class="form-control" name="movie_ozet" id="movie_ozet" rows="5"></textarea>
                                                    </div>
                                                    <div class="col-12 d-flex justify-content-end">

                                                    <?php if($decoder["filmislem"]=="on"){ ?>

                                                        <input type="hidden" name="movieadd">
                                                        <button type="submit" class="btn btn-info me-1 mb-1">Filmi Ekle</button>
